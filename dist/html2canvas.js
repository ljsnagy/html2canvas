...
var parsePathForBorder = exports.parsePathForBorder = function parsePathForBorder(curves, borderWidth, borderSide, overlapNext) {
    var overlap = overlapNext ? borderWidth : 0;
    switch (borderSide) {
        case TOP:
            return createPathFromCurves(curves.topLeftOuter, curves.topLeftInner, curves.topRightOuter, curves.topRightInner instanceof _Vector2.default ? curves.topRightInner.addX(overlap) : curves.topRightInner);
        case RIGHT:
            return createPathFromCurves(curves.topRightOuter, curves.topRightInner, curves.bottomRightOuter, curves.bottomRightInner instanceof _Vector2.default ? curves.bottomRightInner.addY(overlap) : curves.bottomRightInner);
        case BOTTOM:
            return createPathFromCurves(curves.bottomRightOuter, curves.bottomRightInner, curves.bottomLeftOuter, curves.bottomLeftInner instanceof _Vector2.default ? curves.bottomLeftInner.subtractX(overlap) : curves.bottomLeftInner);
        case LEFT:
        default:
            return createPathFromCurves(curves.bottomLeftOuter, curves.bottomLeftInner, curves.topLeftOuter, curves.topLeftInner instanceof _Vector2.default ? curves.topLeftInner.subtractY(overlap) : curves.topLeftInner);
    }
};
    ...
    _createClass(Renderer, [{
        ...
        value: function renderNodeBackgroundAndBorders(container) {
            ...
            var callback = function callback() {
                ...
                container.style.border.forEach(function (border, side, borders) {
                    if (border.borderStyle !== _border.BORDER_STYLE.NONE && !border.borderColor.isTransparent()) {
                        var next = borders[(side + 1) % 4];
                        _this2.renderBorder(border, side, next, container.curvedBounds);
                    }
                });
            };
        ...
        key: 'renderBorder',
        value: function renderBorder(border, side, next, curvePoints) {
            var overlapNext = next.borderColor.isOpaque();
            this.target.drawShape((0, _Bounds.parsePathForBorder)(curvePoints, border.borderWidth, side, overlapNext), border.borderColor);
        }
    }, {
        key: 'renderStack',
